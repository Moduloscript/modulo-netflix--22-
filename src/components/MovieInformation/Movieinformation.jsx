...
import {
  Modal, Typography, Button, ButtonGroup, Grid, Box, CircularProgress, Rating, useMediaQuery,
} from '@mui/material';
import {
          ...
          <div className={classes.buttonsContainer}>
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup size="small" variant="outlined">
                <Button target="blank" rel="noopener noreferrer" href={data?.homepage} endIcon=<Language />>
                  Website
                </Button>
                <Button target="blank" rel="noopener noreferrer" href={`https://www.imdb.com/title/${data.imdb_id}`} endIcon={<MovieIcon />}>
                  IMDB
                </Button>
